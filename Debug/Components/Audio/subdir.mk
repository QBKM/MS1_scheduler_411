...
C_SRCS += \
../Components/Audio/API_buzzer.c 

OBJS += \
./Components/Audio/API_buzzer.o 

C_DEPS += \
./Components/Audio/API_buzzer.d 


# Each subdirectory must supply rules for building sources it contributes
Components/Audio/%.o: ../Components/Audio/%.c Components/Audio/subdir.mk
...
clean: clean-Components-2f-Audio

clean-Components-2f-Audio:
	-$(RM) ./Components/Audio/API_buzzer.d ./Components/Audio/API_buzzer.o

.PHONY: clean-Components-2f-Audio
